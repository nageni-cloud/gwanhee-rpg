...
try: ws_status, ws_logs, ws_col = connect_db_v38_fix()
...
def get_tier(lv):
    ...
    return "Iron", "#717171"
cur_n, cur_c = get_tier(level) # 여기서 에러가 났던 것 해결!
...
COLLECTION_SETS = [
    ...
    {"name": "이브이 4형제", "desc": "진화의 돌이 필요해! 이브이 진화체.", "ids": [133, 134, 135, 136], "reward": 1500},
