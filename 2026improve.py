...
@st.cache_resource
def connect_db_v33(): # 함수명 변경 (캐시 초기화)
...
try: ws_status, ws_logs, ws_col = connect_db_v33()
...
# [메인 타이틀 복구]
st.title(f"🔥 Lv.{level} 관희의 성장 RPG")
...
# 메인 탭
tab1, tab2, tab3 = st.tabs(["🏠 성장", "🏥 뽑기", "🎒 도감"])
